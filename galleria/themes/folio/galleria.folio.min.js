	...
	Galleria.addTheme(
		{   name:"folio",
			...
			init:function(e){
				...
				var B=Galleria.TOUCH?"mousedown":"click";
						...
						k={
								...
								if(c.length){
									for(g=0;g<l;g++)
										...
										c.css(k).each(function(C,h){
															   ...
															   for(g=l-1;g>-1;g--)
															   		if(f[g]===Math.min.apply(window,f))
																		q=g;
																...
																if(!(typeof n.top!=="number"||typeof n.left!=="number")){
																	if(b.speed)
																		window.setTimeout(function(D,z,E){
																								   return function(){
																									   D.animate(E,{
																												 	easing:"galleriaOut",
																													duration:z.speed,
							...
							this.bind("fullscreen_enter",function(){
								...
								t=true
									...
									this.bind("fullscreen_exit",function(){u.hide();
									j.show();
									m.hide();
									t=false});
									this.bind("thumbnail",function(a){this.addElement("plus");
							
							var b=a.thumbTarget,c=this.$("plus").css({display:"block"}).insertAfter(b),k=0;
								...
								A(j,{
									...
									onbrick:function(){
										...
										window.setTimeout(function(){
											   d(l).find("img").animate({opacity:1},
							...
							k++},onheight:function(){o.height(j.height())}})}});
							this.bind("loadstart",function(a){a.cached||v.show()});
							...
							this.bind("loadfinish",function(a){
									...
									r.css("visibility","visible");
									v.hide();
									if(this.hasInfo()&&e.showInfo)
										m.fadeIn(e.transition?e.transitionSpeed:0);
							...
							*/
							if(!Galleria.TOUCH){
								...
								/* this.addIdleState(this.get("close"),{top:-50}) */
							}
							this.$("container").css({
													width:e.width,
													height:"auto"});
							...
							this.$("close").click(function(){i.exitFullscreen()});
							
							d(window).resize(function(){if(t)i.getActiveImage()&&y(i.getActiveImage().width);
