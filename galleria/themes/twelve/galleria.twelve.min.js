...
*/
(function(r){Galleria.addTheme({name:"twelve",author:"Galleria",css:"galleria.twelve.css",defaults:{transition:"fadeslide",transitionSpeed:500,imageCrop:false,thumbCrop:false,carousel:false,_locale:{show_thumbnails:"Show thumbnails",hide_thumbnails:"Hide thumbnails",play:"Play slideshow",pause:"Pause slideshow",enter_fullscreen:"Enter fullscreen",exit_fullscreen:"Exit fullscreen",popout_image:"Popout image",showing_image:"Showing image %s of %s"},_showFullscreen:false,_showPopout:true,_showProgress:true,
